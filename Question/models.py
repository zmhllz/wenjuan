...
class Customer(models.Model):
    ...
    mobile = models.CharField(default='', max_length=16, blank=True, null=True, help_text="座机")
    ...
    web = models.CharField(default='', max_length=64,blank=True, null=True, help_text="网站地址")
    industry = models.CharField(default='', max_length=32, blank=True, null=True, help_text="行业")
...
class ShareHistory(models.Model):
    ...
    url = models.CharField(max_length=128, default='',blank=True, null=True, help_text="分享链接")
    # 关联到Image
    qrcode = models.CharField(max_length=32, null=True,blank=True, help_text="分享二维码")
